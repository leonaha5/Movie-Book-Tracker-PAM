...
class Adapter(private val ksiazkaLubFilmList: List<KisazkaLubFilm>) :
    RecyclerView.Adapter<Adapter.KsiazkaLubFilmViewHolder>() {
    class KsiazkaLubFilmViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): KsiazkaLubFilmViewHolder {
        val itemView =
    ...
    override fun onBindViewHolder(holder: KsiazkaLubFilmViewHolder, position: Int) {
